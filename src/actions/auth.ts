...
export async function handleLoginWithEmailAndPassword(data: { email: string, password: string }) {
...
export async function handleSignUpWithEmailAndPassword(data: { email: string, password: string }) {
