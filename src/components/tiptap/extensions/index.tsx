...
export const defaultExtensions: Array<any> = [
  ...
  Callout.configure({
    ...
    HTMLAttributes: {
      class:
        "relative p-4 pl-12 rounded-md bg-ui text-primary before:content-[attr(data-emoji)] before:absolute before:top-4 before:left-4 before:text-base",
    },
  }),
  TaskList.configure({
    HTMLAttributes: {
  ...
  Code.configure({
    HTMLAttributes: {
      class: "rounded-md bg-ui px-1.5 py-1 font-mono font-medium text-primary",
      spellcheck: "false",
    },
  }),
  CodeBlockLowlight.configure({
    HTMLAttributes: {
      class:
        "rounded-md bg-ui px-1.5 py-1 font-mono text-sm text-primary language-javascript",
      spellcheck: "false",
    },
    lowlight,
  }),
