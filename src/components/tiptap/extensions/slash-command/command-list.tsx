...
export const CommandList = ({
  ...
  return items.length > 0 ? (
    <div
      ...
      className="dark z-50 w-80 h-auto max-h-[330px] overflow-y-auto bg-ui rounded-lg border border-primary p-1 text-primary animate-in shadow-[var(--popover-shadow)]"
    >
